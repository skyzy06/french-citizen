...
public class CitizenServiceTest {
    ...
    public void testCitizenCreationMinimal() {
        ...
        citizen.setPassword(passwordEncoder.encode("BabaYaga1"));
        ...
        assertTrue(passwordEncoder.matches("BabaYaga1", citizen.getPassword()));
    ...
    public void testCitizenMissingNotNullableField() {
        ...
        citizen2.setPassword(passwordEncoder.encode("BabaYaga1"));
        ...
        citizen3.setPassword(passwordEncoder.encode("BabaYaga1"));
        ...
        citizen4.setPassword(passwordEncoder.encode("BabaYaga1"));
    ...
    public void testCitizenUsernameAlreadyExists() {
        ...
        citizen2.setPassword(passwordEncoder.encode("BabaYaga2"));
